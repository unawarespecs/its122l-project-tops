...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#top">Announcements</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="display-5 fw-bold lh-1 mb-3">Announcements</h1>
                    <p class="lead">Announcements from the TOPS staff.</p>
                </div>
            </div>
                ...
                <footer class="py-5">
                    <div class="row">
                        <div class="col-2">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item"><a href="../pages/user_login/login.php" class="nav-link p-0 text-muted">Admin
                                        Login</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-2">
                            <h5>Contact Us</h5>
                            <ul class="nav flex-column">
                                <li class="nav-item mb-2"><text class="p-0 text-muted">Landline: <text
                                            class="text-black">+632 8353-2180</text></text></li>
                                <li class="nav-item mb-2"><text class="p-0 text-muted">Email: <a
                                            href="mailto:topsinc.org@gmail.com"
                                            class="text-black">topsinc.org@gmail.com</a></text></li>
                            </ul>
                        </div>
                    ...
                    <div class="d-flex justify-content-between py-4 my-4 border-top">
                        ...
                        <ul class="list-unstyled d-flex">
                            <li class="ms-3"><a class="link-dark" href="https://web.facebook.com/OfficialTOPs"><svg
