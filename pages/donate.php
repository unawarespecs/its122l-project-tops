...
<body>
    ...
    <main>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="display-5 fw-bold lh-1 mb-3">Donate to Us</h1>
                    <p class="lead">Your donation will help us in our mission to provide education to marginalized
                        children in the Philippines.</p>
                    <p>GCash number: [placeholder]</p>
                </div>
            </div>
