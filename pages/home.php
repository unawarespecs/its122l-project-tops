            ...
            <footer class="py-5">
                <div class="row">
                    ...
                    <div class="col-2">
                        <h5>Contact Us</h5>
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><text class="p-0 text-muted">Landline: <text class="text-black">+632 8353-2180</text></text></li>
                            <li class="nav-item mb-2"><text class="p-0 text-muted">Email: <a href="mailto:topsinc.org@gmail.com" class="text-black">topsinc.org@gmail.com</a></text></li>
                        </ul>
                    </div>
                ...
                <div class="d-flex justify-content-between py-4 my-4 border-top">
                    <p>&copy; 2025, <a class="text-black" href="https://www.mapua.edu.ph">ITS122L Group 4 - BM3</a> and
